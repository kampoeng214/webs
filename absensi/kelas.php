    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Home</span></a></li>
			        ...
			        <li class="active"><a href="kelas.php"><i class="fa fa-columns"></i><span>kelas</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-columns"></i> kelas</li>
          </ol>
        </section>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="kelas_add.php" name="modal_popup" enctype="multipart/form-data" method="get">
