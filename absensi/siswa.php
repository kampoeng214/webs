        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Home</span></a></li>
			        ...
			        <li class="active"><a href="siswa.php"><i class="fa fa-users"></i><span>Siswa</span></a></li>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="siswa_add.php" name="modal_popup" enctype="multipart/form-data" method="get">
							...
							<div class="form-group">
								<label>Mahasiswa</label>
									<div class="input-group">
										...
										<input name="Nama_Siswa" type="text" class="form-control" placeholder="Nama Mahasiswa"/>
									</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>No. Registrasi</label>
			 						<div class="input-group">
										...
										<input name="No_Registrasi" type="text" class="form-control" placeholder="No Registrasi"/>
									</div>
							</div>
							<div class="form-group">
								<label>uid</label>
